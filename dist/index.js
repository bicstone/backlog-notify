...
const has_1 = __importDefault(__webpack_require__(528));
/**
...
const fetchCommits = (path) => readFile(path)
    ...
    .then(data => {
    if (has_1.default(data, "commits") === false) {
...
Object.defineProperty(exports, "__esModule", { value: true });
const getEnvs_1 = __importDefault(__webpack_require__(294));
const fetchCommits_1 = __importDefault(__webpack_require__(74));
const parseCommits_1 = __importDefault(__webpack_require__(270));
const postComments_1 = __importDefault(__webpack_require__(897));
(() => __awaiter(void 0, void 0, void 0, function* () {
    // 環境変数の読み込み
    const { PROJECT_KEY, API_HOST, API_KEY, GITHUB_EVENT_PATH } = yield getEnvs_1.default();
    // event.json の読み込み
    const commits = yield fetchCommits_1.default(GITHUB_EVENT_PATH);
    // コミットの解析
    const parsedCommits = yield parseCommits_1.default(commits, PROJECT_KEY);
    // バックログAPIへ送信
    const response = yield postComments_1.default(API_HOST, API_KEY, parsedCommits);
...
const parseCommits = (data, PROJECT_KEY) => new Promise((resolve, reject) => {
    ...
    data.commits.forEach(commit => {
        ...
        // [3] => キーワード(任意) #fix
        // TODO: 複数の課題キーがある場合
        let result = commit.message.match(RegExp(commitKeywordRegexTemplate({ PROJECT_KEY: PROJECT_KEY }), "s"));
        // 課題キーがなければスキップ
        if (result === null) {
            return;
        }
 ...
 */
exports.getEnvs = () => new Promise((resolve, reject) => {
    // PROJECT_KEY のチェック
...
exports.default = exports.getEnvs;
...
var assignInWith = __webpack_require__(321),
    ...
    escapeStringChar = __webpack_require__(691),
    isError = __webpack_require__(570),
...
var escapeHtmlChar = __webpack_require__(976),
    toString = __webpack_require__(428);
...
var escape = __webpack_require__(682),
    reEscape = __webpack_require__(448),
...
const postComments = (API_HOST, API_KEY, parsedCommits) => {
    ...
    Object.values(parsedCommits).map(parsedCommit => {
        ...
        // コメント本文
        const comment = commentTemplate(Object.assign({ commits: parsedCommit }, parsedCommit[0]));
        // キーワード判定による状態変更
        ...
        promiseArray.push(axios_1.default.patch(apiUrl, querystring_1.default.stringify(Object.assign({ comment: comment }, status)), {
            headers: {
                "Content-Type": "application/x-www-form-urlencoded"
            }
        }));
